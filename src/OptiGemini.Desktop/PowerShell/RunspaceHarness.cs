...
namespace OptiGemini.Desktop.PowerShell;

/// <summary>
/// Manages PowerShell runspace lifecycle with watchdog support
/// Adapted from pocs/runspace/OptiGemini.RunspacePoC/RunspaceHarness.cs
/// </summary>
